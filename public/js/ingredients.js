...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var consultButton = document.querySelector("#btn-suggestions-consult-recipe");
    var form = document.querySelector("#form-suggestions");
    ...
    consultButton.disabled = true;
            ...
            var consult = document.querySelector("#btn-suggestions-consult-recipe");
    ...
    function resultRecipe() {
        ...
        if (rightList.length > 0) { // If at least one ingredient is selected
            if (validRecipes.length < 2) {
                recipesAvailables = "Il y a " + validRecipes.length + " recette disponible";
                ...
                recipesAvailables = "Il y a " + validRecipes.length + " recettes disponible";
                consultButton.disabled = false;
            }
            document.getElementById("suggestions-result-sentence").innerHTML = recipesAvailables;
        } else {
            consultButton.disabled = true;
        }
    }
