class CardsIngredients {
    ...
    createIngredientCards(index) {
        ...
        var containerIngredientCards = document.querySelector('#suggestions-container-ingredient-cards');
        ...
        // Add the image paths
        pictureDiv.style["background-image"] = "url('https://teillier.needemand.com/realisations/Projet_Nesti/Nesti-Project-PHP/public/images/articles/" + this.url +"')";
